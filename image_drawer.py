...
def draw_text(top_text, bottom_text, img_file_path, font_color, font_path, outfile_name):
...
n = 10
rnn = load_pretrained_model("./weights/viper_rnn_gen_text_weights.hdf5")
bottom_texts = rnn.generate(temperature=0.8, n=n, return_as_list=True)
for x in range(0,n):
    draw_text("Viper the Rapper", bottom_texts[x], "arno.jpg", random_color(), select_random_font(), "./img/sample_{}.jpg".format(x))